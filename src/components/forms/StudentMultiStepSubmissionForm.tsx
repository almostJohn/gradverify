...
=======
>>>>>>> 8e55d413778938a91ee64cb3d06964ebf00c4185
...
const departments = [
	...
	},
	{
		...
		programs: ["BS in Hospitality Management", "BS in Tourism Management"],
	},
];
					...
					>
						...
						<span
							className={`mt-2 text-xs font-medium text-center ${
								currentStep === idx + 1 ? "text-blue-600" : "text-gray-400"
							}`}
						>
							{step}
						</span>
						{idx < steps.length - 1 && (
							<div
								className="absolute top-5 right-0 w-full h-0.5 bg-gray-200 z-0"
					...
					{currentStep === 1 && (
						<>
							...
							<p className="text-gray-500 mb-6">
								Please provide your student information to get started with
							...
							<div className="mb-6">
								...
								<p className="text-xs text-gray-400 mt-1">
									As shown on your PSA certificate. You must be at least 15
									years old.
								</p>
							</div>
							<div>
...
>>>>>>> 8e55d413778938a91ee64cb3d06964ebf00c4185
					...
					{currentStep === 2 && (
						<>
							...
							<p className="text-gray-500 mb-6">
								Upload a clear scan or photo of your PSA birth certificate.
							</p>
							<div className="mb-6">
								<label className="block text-sm font-semibold mb-1">
								...
								{formData.psaFile ? (
									<div className="flex items-center gap-2">
										<span className="text-green-600 text-xs font-medium">
											File selected: {formData.psaFile.name}
										</span>
										<button
											type="button"
											className="text-blue-600 text-xs underline"
											onClick={() =>
												setFormData((prev) => ({ ...prev, psaFile: null }))
											}
										>
											Change file
										</button>
								...
								<p className="text-xs text-gray-400 mt-1">
									Accepted formats: JPEG, PNG, PDF (max 5MB). Your file will be
					...
					{currentStep === 3 && (
						<>
							...
							<p className="text-gray-500 mb-6">
								Upload your official graduation photo.
							</p>
							<div className="mb-6">
								<label className="block text-sm font-semibold mb-1">
									Upload Graduation Photo
								...
								{formData.gradPhoto ? (
									<div className="flex items-center gap-2">
										<span className="text-green-600 text-xs font-medium">
											File selected: {formData.gradPhoto.name}
										</span>
										<button
											type="button"
											className="text-blue-600 text-xs underline"
											onClick={() =>
												setFormData((prev) => ({ ...prev, gradPhoto: null }))
											}
										>
											Change file
										</button>
								...
								<p className="text-xs text-gray-400 mt-1">
									Accepted formats: JPEG, PNG (max 5MB). Your file will be
									uploaded when you submit the form.
								</p>
							</div>
						</>
					...
					{currentStep === 4 && (
						<>
							...
							<p className="text-gray-500 mb-6">
								Upload any academic award certificates (optional).
							</p>
							<div className="mb-6">
								<label className="block text-sm font-semibold mb-1">
									Upload Academic Awards{" "}
									<span className="text-gray-400 font-normal">(optional)</span>
								</label>
								{formData.awards ? (
									<div className="flex items-center gap-2">
										<span className="text-green-600 text-xs font-medium">
											File selected: {formData.awards.name}
										</span>
										<button
											type="button"
											className="text-blue-600 text-xs underline"
											onClick={() =>
												setFormData((prev) => ({ ...prev, awards: null }))
											}
										>
											Change file
										</button>
								...
								<p className="text-xs text-gray-400 mt-1">
									Accepted formats: JPEG, PNG, PDF (max 5MB). If you don't have
									any awards, you can leave this blank.
								</p>
							</div>
						</>
					)}
